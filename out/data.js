...
exports.COMMON_CLASSES = exports.PLAY_EFFECT_COLORS = exports.MINIMAP_COLORS = exports.MINIMAP_SHAPES = exports.KEYWORDS = exports.BLOCK_HEADERS = void 0;
exports.getKeywordDef = getKeywordDef;
exports.getAllKeywords = getAllKeywords;
exports.getBlockBodyKeywords = getBlockBodyKeywords;
// ── Complete keyword definitions ─────────────────────────────────────
exports.BLOCK_HEADERS = [
    {
        keyword: 'Show',
...
for (const k of exports.BLOCK_HEADERS) {
    keywordMap.set(k.keyword.toLowerCase(), k);
}
function getKeywordDef(keyword) {
    return keywordMap.get(keyword.toLowerCase());
}
function getAllKeywords() {
    return [...exports.BLOCK_HEADERS, ...exports.KEYWORDS];
}
function getBlockBodyKeywords() {
    return exports.KEYWORDS;
}
// MinimapIcon shapes
exports.MINIMAP_SHAPES = [
    'Circle', 'Diamond', 'Hexagon', 'Square', 'Star',
    'Triangle', 'Cross', 'Moon', 'Raindrop', 'Kite',
    'Pentagon', 'UpsideDownHouse',
];
exports.MINIMAP_COLORS = [
    'Red', 'Green', 'Blue', 'Brown', 'White', 'Yellow',
    'Cyan', 'Grey', 'Orange', 'Pink', 'Purple',
];
exports.PLAY_EFFECT_COLORS = [
    'Red', 'Green', 'Blue', 'Brown', 'White', 'Yellow',
    'Cyan', 'Grey', 'Orange', 'Pink', 'Purple',
];
// Common class names for completion
exports.COMMON_CLASSES = [
    // ── Default (shared) ──
