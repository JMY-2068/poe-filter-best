...
### 10. Block 状态切换 / Block Toggle（v4 新增）
...
### 13. BaseType 链接 / BaseType Links（v5 新增，v6 增强）
...
### 14. 参数选择器 / Parameter Pickers（v5 新增）
...
### 19. Block Explorer 面板 / Block Panel（v6 新增）
...
### 20. Title bar 音效切换 / Sound Mode Toggle（v7 新增）
...
### 21. 全局批量操作 / Global Operations（v7 新增）
